          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 pt-1">
              <a
                ...
                rel="noreferrer"
                aria-label="Facebook"
                className="w-7 h-7 rounded-full bg-[#F7F4EC] hover:bg-[#B82025] hover:text-white flex items-center justify-center transition-colors text-[#17352A] border border-[#E5E0D4]"
              >
