  ...
  return (
    <footer className="bg-white text-[#1D2521] border-t border-[#E5E0D4]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 pb-12 border-b border-[#E5E0D4]">
          ...
          <div className="space-y-4 lg:col-span-1">
            <Link href="/" className="flex items-center gap-2.5 sm:gap-3 group shrink-0">
              ...
              <div className="flex flex-col">
                <span className="text-lg font-black tracking-tight text-[#1D2521] uppercase font-display leading-none">
            ...
            <div className="flex items-center gap-2 pt-2">
              <a
                ...
                rel="noreferrer"
                aria-label="Facebook"
                className="w-8 h-8 rounded-full bg-[#F7F4EC] hover:bg-[#B82025] hover:text-white flex items-center justify-center transition-colors text-[#1D2521] border border-[#E5E0D4]"
              >
