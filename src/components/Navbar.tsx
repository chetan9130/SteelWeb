      ...
      <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="flex items-center gap-1.5">
                <a
                  ...
                  rel="noreferrer"
                  aria-label="Facebook"
                  className="w-6 h-6 rounded-full bg-[#B82025] hover:bg-[#8F171C] flex items-center justify-center transition-all text-white hover:scale-105 shadow-2xs"
                >
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
            {/* Left: Brand Logo (Only Logo Image) */}
                  ...
                  <Link
                    ...
                    className={`relative px-3 py-2 text-xs font-bold uppercase tracking-wider transition-all rounded-xs group ${
                      isActive
                        ...
                        : "text-[#17352A] hover:text-[#B82025] hover:bg-[#F7F4EC]/60"
                    }`}
                  >
            ...
            <div className="flex lg:hidden items-center gap-2.5">
              ...
              <button
                ...
                className="p-2 text-[#17352A] hover:bg-[#F7F4EC] rounded-sm border border-[#E5E0D4] transition-colors"
        ...
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          <div className="fixed top-0 right-0 bottom-0 w-full max-w-sm bg-white z-50 p-6 flex flex-col justify-between shadow-2xl animate-in slide-in-from-right duration-300 overflow-y-auto">
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center justify-between p-3 text-sm font-bold uppercase tracking-wider rounded-sm transition-all ${
                        isActive
                          ? "bg-[#17352A] text-white shadow-xs"
                          : "text-[#17352A] hover:bg-[#F7F4EC] hover:text-[#B82025]"
                      }`}
                    >
                      <span>{link.label}</span>
                      <ChevronRight className={`w-4 h-4 ${isActive ? "text-[#C89446]" : "text-[#6B716D]"}`} />
                    </Link>
                  );
                })}
              </nav>
            ...
            <div className="pt-6 space-y-3 border-t border-[#E5E0D4] mt-6">
              ...
              <Link
                href="/quote"
                className="w-full py-3.5 bg-[#B82025] hover:bg-[#8F171C] text-white text-xs font-extrabold uppercase tracking-wider rounded-sm flex items-center justify-center gap-2 transition-colors shadow-sm"
              >
